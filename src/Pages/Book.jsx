            ...
            <div className="book-info">
              ...
              <div className="action-section d-flex align-items-center mb-4">
                ...
                <Button
                  ...
                  className="ms-3 wishlist-btn rounded-circle d-flex align-items-center justify-content-center"
                  onClick={() => setIsFavorite(!isFavorite)}
                >
                  {isFavorite ? <i className='bi bi-heart-fill' /> : <i className='bi bi-heart' />}
                </Button>
              </div>
