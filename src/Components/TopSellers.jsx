...
const TopSellers = () => {
  ...
  //Generate Number between 3-5 excluding 5 
  ...
  return (
    <>
      <section className="top-sellers-section py-5">
        <Container>
          {/* Section Header */}
              ...
              <SwiperSlide key={book._id}>
                <Card as={Link} to={`/books/${book._id}`} className="text-decoration-none h-100 border-0 shadow-sm book-card overflow-hidden">
                  <div className="position-relative overflow-hidden border-0">
                    ...
                    <Button
                      variant="link"
                      className="z-1 align-middle position-absolute bg-light lh-1 rounded-circle shadow-sm d-flex align-items-center justify-content-center p-2"
                      style={{
                        top: "15px",
                        right: "15px",
                        width: "40px",
